/*
  ...
  @param: c1 => the first color, hex (ie: #000000)
  @param: c2 => the second color, hex (ie: #ffffff)
  @param: percentage  => the distance from the first color, as a decimal between 0 and 1 (ie: 0.5)
  @returns: string    => the third color, hex, represenatation of the blend between color1 and
   color2 at the given percentage
*/
const blendColors = (c1 = '#000000', c2 = '#ffffff', percentage = 0.5) => {
  let color1 = c1;
  let color2 = c2;
  let color3;
...
*/
  ...
  // 4: blend
  color3 = [
    (1 - percentage) * color11[0] + percentage * color22[0],
    (1 - percentage) * color11[1] + percentage * color22[1],
    (1 - percentage) * color11[2] + percentage * color22[2],
  ];
